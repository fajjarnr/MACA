...
import com.example.maca.fragment.Model.Adapter.MyGroupAdapterExplore
 ...
 */
class ExploreFragment : Fragment(), IFirebaseLoadListener {
    override fun onFirebaseLoadSuccess(itemGroupList: List<ItemGroup>) {
        val adapter = MyGroupAdapterExplore(activity!!, itemGroupList)
