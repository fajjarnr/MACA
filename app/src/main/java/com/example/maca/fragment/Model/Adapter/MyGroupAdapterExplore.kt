...
class MyGroupAdapterExplore(
    private val context: Context,
    private val dataList: List<ItemGroup>?
) : RecyclerView.Adapter<MyGroupAdapterExplore.MyViewHolder>() {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyViewHolder {
        val view: View?
        view = LayoutInflater.from(context).inflate(R.layout.layout_group_explore, p0, false)
    ...
    override fun onBindViewHolder(myViewHolder: MyViewHolder, position: Int) {
        ...
        myViewHolder.recycler_view_list.layoutManager = GridLayoutManager(context, 3)
        ...
        myViewHolder.btnMore.setOnClickListener {
            Toast.makeText(
                context,
                "Btn More: " + dataList!![position].headerTitle,
                Toast.LENGTH_SHORT
            ).show()
        }
    }
