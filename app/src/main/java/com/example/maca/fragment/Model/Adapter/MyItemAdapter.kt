...
class MyItemAdapter(
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyViewHolder {
        val view: View?
        view = LayoutInflater.from(context).inflate(R.layout.layout_item, p0, false)
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        //internal var listener:IItemClickListener?=null
       // fun setListener(listener: IItemClickListener){
